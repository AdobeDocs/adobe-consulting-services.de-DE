...
AEM-Inhalte und -Metadaten werden von AEM mit VPN synchronisiert, wenn der Integrations-Workflow ausgelöst wurde. Dies kann automatisch oder manuell erfolgen. VPM-Metadaten werden von VPM mit AEM synchronisiert. Dies kann automatisch über eine Planung oder manuell über einen Schaltflächen-Klick erfolgen.
...
* Die Integration unterstützt zwar modulare AEM-Inhalte (Inhaltsfragmente und Experience Fragments), unterstützt jedoch keine modularen VPM-Inhalte.
* Verknüpfte VPM-Dokumente werden nicht unterstützt.
* Das Synchronisieren von visuellen VVPM-Anmerkungen aus VVPM mit AEM wird nicht unterstützt.
* Die Integration importiert keine Inhalte aus VPM in AEM.
